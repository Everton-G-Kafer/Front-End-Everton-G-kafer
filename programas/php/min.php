...
<body>
  ...
  <div class="quadro">
    ...
    <form method="get">
      <h1 class="h1php">Menor valor</h1>
      <p class="pphp">Exibe o menor valor dentre os apresentados.</p>
      <br>
    ...
    <div class="divphp">
      <?php
        if (isset($_GET["valor1"]) && isset($_GET["valor2"]) && isset($_GET["valor3"]) && isset($_GET["valor4"])) {
          ...
          $valor3 = $_GET["valor3"];
          $valor4 = $_GET["valor4"];
          $resultado = min($valor1, $valor2, $valor3, $valor4);

          echo "<p>O menor valor é $resultado.</p>";
        } else {
